                  ...
                  <ul className="site-menu js-clone-nav mx-auto d-none d-lg-block">
                    ...
                    <li className="has-children">
                      ...
                      <ul className="dropdown">
                        <li><Link to="/gallery">Nature</Link></li>
                ...
                <ul className="site-menu js-clone-nav ml-auto list-unstyled d-flex text-right mb-0"
                  ...
                  <li>
                    <a href="https://www.facebook.com/True.Visionary.Images/"
                       className="pl-0 pr-3" target="_blank"><span className="icon-facebook"/></a>
                  </li>
                  <li>
                    <a href="https://www.instagram.com/_truevisionary/" target="_blank"
