...
namespace MiniORM
{
    public abstract class DbContext
    {
        ...
        internal static readonly Type[] AllowedSqlTypes =
       {
        ...
        private void MapCollection<TDSet, TCollection>(DbSet<TDSet> dbSet, PropertyInfo collectionProperty)
            where TDSet : class, new() where TCollection : class, new()
        {
        ...
        {
            var dbSets = GetType().GetProperties().Where(pi => pi.PropertyType
